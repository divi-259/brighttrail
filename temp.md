...
I am picking chunk size = 1000 and Overlap as 0. 
I am chunking the corpus based on paragraphs and if there is a possibility of adding more paragraphs by keeping the chunk size within 1000, I will take more than on paragraphs in that case. 
For smaller documents in campus_life - it is easily going to chunk each document as one chunk as there are small paragraphs.
And for corpus like city_guides where there are large paragraphs, we will have one chunk for 1 paragraph.
